...
After completing the three chapters of
...
[1.5 Programming `teenygrad` *Level 0*: Accelerating the `BLAS` on CPU](#15-programming-teenygrad-level-0-accelerating-the-blas-on-cpu), and
