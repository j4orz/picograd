...
- [1.2 Statistical Learning of Continuously Stochastic *Maps* with `numpy`](#12-statistical-learning-of-continuously-stochastic-maps-with-numpy)
  ...
  - [1.2.5 Logistic Regression and Cross Entropy Loss]()
  - [1.2.6 Limitations of Direct Optimization]()
  - [1.2.7 Fitting a Line Iteratively with Derivatives of Hilbert Space in Gradient Descent]()
  - [1.2.8 Generalized Linear Models: Linear and Logistical Regression]()
  - [1.2.9 Generalization, Bias-Variance Tradeoff, and Double Descent]()
- [1.3 Programming `teenygrad` Accelerated Tensors](#14-programming-teenygrad-level--1-tensor-the-multidimensional-array)
  - [1.3.1 The Simplest `Tensor` Implementation with Nested `list`s]()
  - [1.3.2 Improving the Locality of `Tensor` by Decoupling Copies and Views with Strides]()
  - [1.3.3 Implementing Basic Linear Algebra Subroutines: `SAXPY`, `SGEMV` and `SGEMM`]()
  - [1.3.1 A Programmer's Perspective on Processor Pipelines and Memory Hierarchies]()
  - [1.3.2 Accelerating Computation with Instruction Level Parallelism via Loop Unrolling]()
  - [1.3.3 Accelerating Computation with Data Level Parallelism via Vector and Matrix Extensions]()
  - [1.3.4 Accelerating Communication with Memory Hierarchies via Register and Cache Blocking]()
  - [1.3.5 Accelerating Computation with Thread Level Parallelism]()
- [1.4 Programming `teenygrad`: Optimization and Differentiation](#16-programming-teenygrad-level-1-optimization-and-differentiation)
  - [1.4.1 Symbolic, Numerical, and Automatic Differentiation]()
  - [1.4.2 Forward Mode Automatic Differentiation with `Tensor.forward()`]()
  - [1.4.3 Reverse Mode Automatic Differentiation with `Tensor.backward()`]()
  - [1.4.4 Iterative Optimization with Stochastic Gradient Descent `optim.sgd`]()
...
## 1.2 Statistical Learning of Continuously Stochastic *Regressive Maps* with `numpy`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
