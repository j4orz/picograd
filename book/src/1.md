...
- [1.2 Statistical Learning of Continuously Stochastic *Functions* with `numpy`](#12-statistical-learning-of-continuously-stochastic-maps-with-numpy)
...
- [1.3 Programming Accelerated Basic Linear Algebra Subroutines with `teenygrad.Tensor`](#14-programming-teenygrad-level--1-tensor-the-multidimensional-array)
...
## 1.2 Statistical Learning of Continuously Stochastic *Functions* with `numpy`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
## 1.3 Programming Accelerated Basic Linear Algebra Subroutines with `teenygrad.Tensor`
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
### 1.3.4 Accelerating CPython with Extension Modules via PyO3 and Rust

### 1.3.5 Accelerating `GEMM` on CPU with `Rust`
```rust
...
### 1.3.6 A Programmer's Perspective on Computation and Communication: Pipelines and Hierarchies
...
### 1.3.7 Accelerating Computation with Instruction Level Parallelism via Loop Unrolling
### 1.3.8 Accelerating Computation with Data Level Parallelism via Vector and Matrix Extensions
### 1.3.9 Accelerating Communication with Memory Hierarchies via Register and Cache Blocking
### 1.3.10 Accelerating Computation with Thread Level Parallelism
