...
- [1.4 Programming `teenygrad` *Level -1*: Tensor, the Multidimensional Array](#14-programming-teenygrad-level--1-tensor-the-multidimensional-array)
...
- [1.5 Programming `teenygrad` *Level 0*: Accelerating the `GEMM` on CPU](#15-programming-teenygrad-level-0-accelerating-the-blas-on-risc-v-cpus-with-rustc)
  - [1.5.1 A Programmer's Perspective on Processor Pipelines and Memory Hierarchies]()
  - [1.5.2 Accelerating Computation with Instruction Level Parallelism via Loop Unrolling]()
  - [1.5.3 Accelerating Computation with Data Level Parallelism via Vector and Matrix Extensions]()
  - [1.5.4 Accelerating Communication with Memory Hierarchies via Register and Cache Blocking]()
  - [1.5.5 Accelerating Computation with Thread Level Parallelism]()
...
## 1.4 Programming `teenygrad` *Level -1*: Tensor, the Multidimensional Array
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
