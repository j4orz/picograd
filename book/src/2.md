...
- [2.1 Learning Sequences with Deep Neural Networks in `torch`]()
  - [2.1.1 Learning XOR with Feedforward Neural Networks](#211-ffn-feedforward-neural-network)
  - [2.1.2 Learning Sentiment with Feedforward Neural Networks]()
  - [2.1.3 Learning Representations with Feedforward Neural Networks]()
  - [2.1.4 Learning Sequences with Feedforward Neural Networks]()
  - [2.1.5 Learning Sequences with Convolutional Neural Networks]()
  - [2.1.6 Learning Sequences with Recurrent Neural Networks]()
...
- [2.2 Programming GPU Accelerated Automatic Differentation with `teenygrad.Tensor.backward()`](#16-programming-teenygrad-level-1-optimization-and-differentiation)
