...
- [2.1 Sequence Learning with Deep Neural Networks in `pytorch`](#21-learning-sequences-with-deep-neural-networks-in-torch)
  ...
  - [2.1.2 Learning Representations with Feedforward Neural Networks]()
...
- [2.2 Programming GPU Accelerated Automatic Differentation with `teenygrad.Tensor.backward()`](#22-programming-gpu-accelerated-automatic-differentation-with-teenygradtensorbackward)
