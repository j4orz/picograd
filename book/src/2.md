...
In part three, you will add midtraining and posttraining to your pretrained transformer to add assistant and reasoning behavior,
and evolve `teenygrad`'s implementation for the final time to support graph mode, fusion compilation.
...
- [2.1 Sequence Learning with Deep Neural Networks in `pytorch`](#21-learning-sequences-with-deep-neural-networks-in-torch)
  - [2.1.1 Learning Price and Sentiment with Feedforward Neural Networks]()
  - [2.1.2 Learning Embeddings with Feedforward Neural Networks]()
  - [2.1.2 Learning Sequences with Feedforward Neural Networks]()
  - [2.1.3 Learning Sequences with Convolutional Neural Networks]()
  - [2.1.4 Learning Sequences with Recurrent Neural Networks]()
  - [2.1.5 Learning Sequences with Bidirectional Encoder Representations from Transformers]()
  - [2.1.6 Learning Sequences with Generative Pretrained Transformers]()
  - [2.1.7 Learning Sequences with Diffusion Models]()
...
### 2.1.1 Learning XOR with Feedforward Neural Networks
...
### 2.1.2 Learning Representations with with Feedforward Neural Networks
